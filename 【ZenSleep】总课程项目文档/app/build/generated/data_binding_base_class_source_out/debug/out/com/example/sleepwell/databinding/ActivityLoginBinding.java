...
public final class ActivityLoginBinding implements ViewBinding {
  ...
  private ActivityLoginBinding(@NonNull LinearLayout rootView, @NonNull Button btnRegister,
      @NonNull Button buttonLogin, @NonNull EditText editTextEmail, @NonNull EditText editTextName,
  ...
  public static ActivityLoginBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityLoginBinding((LinearLayout) rootView, btnRegister, buttonLogin,
