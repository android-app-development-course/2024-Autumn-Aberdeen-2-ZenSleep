...
public final class ActivityEditPostBinding implements ViewBinding {
  ...
  private ActivityEditPostBinding(@NonNull LinearLayout rootView, @NonNull Button buttonPost,
      @NonNull Button buttonSelectImage, @NonNull Button buttonTakePhoto,
      @NonNull EditText editText, @NonNull LinearLayout imageContainer) {
  ...
  public static ActivityEditPostBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityEditPostBinding((LinearLayout) rootView, buttonPost, buttonSelectImage,
          buttonTakePhoto, editText, imageContainer);
    }
